...
public class RutaAlimentadora implements Runnable {
    private int ciclos; // Cantidad de ciclos que va a ejecutarse la ruta alimentadora
    ...
    public void run() {
        ...
        for (int i = 0; i < this.ciclos; i++) {
            ...
            if (i % 5 == 0) {
                ...
                if (probabilidad.nextDouble() >= 0.65)  central = 1; // la persona va a la central norte
                else central = 2; // va a la central sur
